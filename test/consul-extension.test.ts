...
describe('consulmesh', () => {
  test.only('Test extension with default params', () => {
    // WHEN
    ...
    nameDescription.add(
      new ECSConsulMeshExtension({
        retryJoin: new RetryJoin({
          region: 'us-west-2',
          tagName: 'Name',
          tagValue: 'test-consul-server',
        }),
        ...
        aclSecretArn:
          'arn:aws:secretsmanager:us-east-2:1234556789:secret:i-07c446_consulAgentCaCert-NBIwAK',
        healthCheck: {
    ...
    template.hasResourceProperties('AWS::ECS::TaskDefinition', {
      ContainerDefinitions: [
        ...
        },
        {
          ...
          Essential: false,
          HealthCheck: {
            Command: ['CMD', 'nc', '-z', '127.0.0.1', '20000'],
            Interval: 30,
            Retries: 3,
            Timeout: 5,
          },
      ...
      Cpu: '1024',
      ExecutionRoleArn: {
        'Fn::GetAtt': ['greetertaskdefinitionExecutionRoleAED0EC79', 'Arn'],
      },
      ...
      TaskRoleArn: {
        'Fn::GetAtt': ['greetertaskdefinitionTaskRole2A098ACC', 'Arn'],
      },
      Volumes: [
        {
          Name: 'consul-data',
    ...
    template.hasResourceProperties('AWS::ECS::TaskDefinition', {
      ContainerDefinitions: [
        ...
        {
          Command: ['health-sync', '-health-sync-containers=app', '-service-name=name'],
          DependsOn: [
            {
              Condition: 'SUCCESS',
              ContainerName: 'consul-ecs-mesh-init',
      ...
      Cpu: '1024',
      ExecutionRoleArn: {
        'Fn::GetAtt': ['nametaskdefinitionExecutionRole45AC5C9A', 'Arn'],
      },
      ...
      RequiresCompatibilities: ['EC2', 'FARGATE'],
      TaskRoleArn: {
        'Fn::GetAtt': ['nametaskdefinitionTaskRole50FE844E', 'Arn'],
      },
      Volumes: [
        {
          Name: 'consul-data',
    ...
    template.hasResourceProperties('AWS::ECS::Service', {
      ...
      NetworkConfiguration: {
        AwsvpcConfiguration: {
          ...
          SecurityGroups: [
            {
              'Fn::GetAtt': ['nameserviceSecurityGroup33F4662C', 'GroupId'],
            },
            {
              'Fn::GetAtt': ['consulClientSecurityGroup279D3373', 'GroupId'],
            },
          ],
          Subnets: [
            {
    ...
    template.hasResourceProperties('AWS::ECS::Service', {
      ...
      NetworkConfiguration: {
        AwsvpcConfiguration: {
          ...
          SecurityGroups: [
            {
              'Fn::GetAtt': ['greeterserviceSecurityGroupDB4AC3A9', 'GroupId'],
            },
            {
              'Fn::GetAtt': ['consulClientSecurityGroup279D3373', 'GroupId'],
            },
