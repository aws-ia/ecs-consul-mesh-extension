...
&nbsp;
export async function <span class="fstat-no" title="function not covered" >createLibraryReadme(</span>namespace: string, readmePath: string) {
  const module = <span class="cstat-no" title="statement not covered" >createModuleDefinitionFromCfnNamespace(namespace);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  await fs.writeFile(readmePath, [</span>
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Nov 09 2021 11:26:54 GMT+0000 (Coordinated Universal Time)
            </div>
        </div>
